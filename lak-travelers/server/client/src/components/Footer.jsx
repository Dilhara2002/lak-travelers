    ...
    <footer className="bg-white border-t border-gray-100 pt-10 md:pt-16 pb-8 mt-auto">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 text-center md:text-left">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
              Founded by Mr. Wijesinghe. Experience the pearl of the Indian Ocean. We provide luxury hotels, curated tours, and reliable vehicle rentals across Sri Lanka.
            </p>
          </div>
          ...
          {/* Column 4: Contact & Social Presence - UPDATED WITH REAL DATA */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4">Contact Us</h3>
            <ul className="space-y-3 text-sm text-gray-500 mb-6">
              <li className="flex items-start gap-3 justify-center md:justify-start">
                <span className="text-blue-600">📍</span>
                <span>73/D Walagedara, Wattappola,<br/>Sri Lanka</span>
              </li>
              <li className="flex items-center gap-3 justify-center md:justify-start">
                <span className="text-blue-600">📞</span>
                <span>+94 72 320 1365</span>
              </li>
              <li className="flex items-center gap-3 justify-center md:justify-start">
                <span className="text-blue-600">✉️</span>
                <span>laktravelers@gmail.com</span>
              </li>
            </ul>
            
            {/* Social Media Links */}
            <div className="flex gap-4 justify-center md:justify-start">
              <a href="https://www.facebook.com/share/1FUwwhbKyf/?mibextid=wwXIfr" className="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href="#" className="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center text-pink-600 hover:bg-pink-600 hover:text-white transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 text-center md:text-left">
          <p>&copy; {new Date().getFullYear()} Lak Travelers 🇱🇰. Owned by Mr. Wijesinghe. Proudly Explore Sri Lanka.</p>
          <div className="flex gap-6 mt-4 md:mt-0">
            <Link to="/PrivacyPolicy" className="hover:text-blue-600 transition">Privacy Policy</Link>
